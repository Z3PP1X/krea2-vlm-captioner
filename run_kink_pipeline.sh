...
echo " Skills     : Krea 2 Narrative & Comprehensive Bondage Taxonomy"
echo " Length     : 550 - 1024 Tokens per caption (~380 - 500+ words)"
echo " Temperature: 0.75 (Diverse, high-fidelity sensory descriptions)"
echo " Batch Size : 32 (Parallel GPU Sub-Batch: 16)"
echo " Workers    : 16"
