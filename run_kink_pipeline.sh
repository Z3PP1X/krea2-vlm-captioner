...
echo " Skills     : Krea 2 (7-Layer Narrative) & Shibari/Bondage Taxonomy"
echo " Length     : >= 400 Tokens per caption (Max Budget: 750 tokens)"
echo " Temperature: 0.75 (Diverse, high-fidelity sensory descriptions)"
echo " Batch Size : 32 (Parallel GPU Sub-Batch: 8-16)"
echo " Workers    : 16"
